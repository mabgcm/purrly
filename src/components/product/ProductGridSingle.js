...
const ProductGridSingle = ({
  ...
  const discountedPrice = product.price ? getDiscountPrice(product.price, product.discount) : null;
  ...
  // Ensure product.image is defined and has elements
          ...
          <Link to={process.env.PUBLIC_URL + "/product/" + product.id}>
            {productImages[0] && (
              <img
                ...
                src={process.env.PUBLIC_URL + productImages[0]}
                alt="product"
              />
            )}
            {productImages.length > 1 && productImages[1] && (
              <img
                className="hover-img"
                src={process.env.PUBLIC_URL + productImages[1]}
                alt="product"
              />
            )}
          </Link>
